...
class PropertyHelperTest extends TestCase
{
    ...
    public function testFastCreateFields(): void
    {
        ...
        $expected = '<div class="input radio"><label>Status</label><input type="hidden" name="status" id="fast_create_docs_status" value=""/><label for="fast_create_docs_status-on"><input type="radio" name="status" value="on" id="fast_create_docs_status-on" class="fastCreateField required" data-name="status" key="documents-status" v-model="object.attributes.status">On</label><label for="fast_create_docs_status-draft"><input type="radio" name="status" value="draft" id="fast_create_docs_status-draft" class="fastCreateField required" data-name="status" key="documents-status" v-model="object.attributes.status">Draft</label><label for="fast_create_docs_status-off"><input type="radio" name="status" value="off" id="fast_create_docs_status-off" class="fastCreateField required" data-name="status" key="documents-status" v-model="object.attributes.status">Off</label></div><div class="input title text"><label for="fast_create_docs_title">Title</label><input type="text" name="title" class="fastCreateField" id="fast_create_docs_title" data-name="title" key="documents-title" value=""/></div><div class="input textarea"><label for="fast_create_docs_description">Description</label><textarea name="description" v-jsoneditor="true" class="fastCreateField fastCreateField" id="fast_create_docs_description" data-name="description" key="documents-description" rows="5"></textarea></div><div class="input textarea"><label for="fast_create_docs_body">Body</label><textarea name="body" v-jsoneditor="true" class="fastCreateField fastCreateField" id="fast_create_docs_body" data-name="body" key="documents-body" v-richeditor="&quot;&quot;" rows="5"></textarea></div><div class="input textarea"><label for="fast_create_docs_extra">Extra</label><textarea name="extra" v-jsoneditor="true" class="json fastCreateField" id="fast_create_docs_extra" data-name="extra" key="documents-extra" rows="5">null</textarea></div><div class="date-ranges-item mb-1"><div><div class="input textarea"><label for="start_date_0">From</label><textarea name="date_ranges[0][start_date]" v-jsoneditor="true" class="fastCreateField" id="start_date_0" data-name="date_ranges" key="documents-date_ranges" v-datepicker="true" date="true" time="true" daterange="true" rows="5">&quot;&quot;</textarea></div><div class="input textarea"><label for="end_date_0">To</label><textarea name="date_ranges[0][end_date]" v-jsoneditor="true" class="fastCreateField" id="end_date_0" data-name="date_ranges" key="documents-date_ranges" v-datepicker="true" date="true" time="true" daterange="true" rows="5">&quot;&quot;</textarea></div><div class="input checkbox"><input type="hidden" name="date_ranges[0][params][all_day]" value="0"/><label for="all_day_0"><input type="checkbox" name="date_ranges[0][params][all_day]" value="""" v-jsoneditor="true" class="fastCreateField" id="all_day_0" data-name="date_ranges" key="documents-date_ranges">All Day</label></div></div></div><input type="hidden" name="_jsonKeys" id="jsonkeys" value="extra,description,body"/>';
        static::assertEquals($expected, $actual);
    }
    ...
    public function testDateRange(): void
    {
        ...
        $expected = '<div class="date-ranges-item mb-1"><div><div class="input textarea"><label for="start_date_0">From</label><textarea name="date_ranges[0][start_date]" v-jsoneditor="true" class="json" id="start_date_0" v-datepicker="true" date="true" time="true" daterange="true" rows="5">&quot;&quot;</textarea></div><div class="input textarea"><label for="end_date_0">To</label><textarea name="date_ranges[0][end_date]" v-jsoneditor="true" class="json" id="end_date_0" v-datepicker="true" date="true" time="true" daterange="true" rows="5">&quot;&quot;</textarea></div><div class="input checkbox"><input type="hidden" name="date_ranges[0][params][all_day]" value="0"/><label for="all_day_0"><input type="checkbox" name="date_ranges[0][params][all_day]" value="""" v-jsoneditor="true" class="json" id="all_day_0">All Day</label></div></div></div>';
        static::assertEquals($expected, $actual);
    }
}
