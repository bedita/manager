...
class LayoutHelperTest extends TestCase
{
    ...
    public function testTrashLink(): void
    {
        ...
        $expected = '<a href="/trash?filter%5Btype%5D%5B0%5D=dummies" class="button icon icon-only-icon has-text-module-dummies" title="Dummies in Trashcan"><span class="is-sr-only">Trash</span><icon-trash-can-32></icon-trash-can-32></a>';
