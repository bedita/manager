...
class ModulesController extends AppController
{
    ...
    /**
     * Display new translation form.
     *
     * @param string|int $id Resource ID.
     * @return \Cake\Http\Response|null
     */
    public function createTranslation($id) : ?Response
    {
        $this->viewBuilder()->setTemplate('translation');
     ...
     * @return \Cake\Http\Response|null
     */
    public function translation($id, $lang) : ?Response
    {
        $this->request->allowMethod(['get']);
    ...
    public function saveTranslation() : ?Response
    {
        ...
        try {
            ...
            return $this->redirect([
                '_name' => 'modules:createTranslation',
                'object_type' => $this->objectType,
                'id' => $objectId,
            ]);
        }
     ...
     * @return \Cake\Http\Response|null
     */
    public function deleteTranslation() : ?Response
    {
        $this->request->allowMethod(['post']);
