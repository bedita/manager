...
export default {
    ...
    `<div v-if="relationName" class="edit-relation">
        <section>
            <header class="mx-1 mt-1 mb-1 tab unselectable">
                <h2><span><: i18n.relationParameters :> - <: relationName | humanize :></span></h2>
            </header>
            ...
            <div class="mx-1">
                ...
                <p class="mt-1 mb-05"><: i18n.inRelationWith :> “<: object.attributes.title :>”</p>
                <div>
            ...
            <footer class="p-1">
                <button :disabled="!isModified"
                    ...
                    @click.prevent="saveParams()"><: i18n.save :></button>

                    <button class="mx-1" href="#" @click="closeParamsView()"><: i18n.cancel :></button>
            </footer>
        </section>
    </div>`,
    ...
    props: {
        ...
        i18n: {
            ...
            default: {
                priority: t`Priority`,
                relationParameters: t`Relation parameters`,
                inRelationWith: t`In relation with`,
                save: t`Save`,
                cancel: t`Cancel`,
            },
        },
