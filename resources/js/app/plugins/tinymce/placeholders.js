    ...
    editor.on('PreInit', function () {
        editor.parser.addAttributeFilter('data-placeholder', function(nodes) {
            nodes.forEach((node) => {
                ...
                let [, id, params] = match;
                node.attr('data-params', params ? placeholderParamsDecoded(params) : '');
        ...
        editor.serializer.addAttributeFilter('data-placeholder', function(nodes) {
            nodes.forEach((node) => {
                ...
                comment.value = `BE-PLACEHOLDER.${id}.${placeholderParamsEncode(params)}`;
                node.append(comment);
            });
        });
    });
        ...
        onAction() {
            ...
            let onSave = (objects) => {
                ...
                objects.forEach((data) => {
                    ...
                    }, `<!-- BE-PLACEHOLDER.${data.id}.${placeholderParamsEncode(data.params)} -->`);
